...
public class ViewingFigures 
{
	...
	JavaPairRDD<Integer, Integer> cc = chapterData.mapToPair(row-> new Tuple2<Integer, Integer>(row._2,1))
	                   .reduceByKey((value1,value2)->value1+value2);             
		//cc.foreach(value-> System.out.println(value));
	// 1.distinct views 	
	...
	// joined.foreach(value-> System.out.println(value));
...
//step3.foreach(value -> System.out.println(value));
	//views count
	step3.reduceByKey((value1,value2)->value1+value2);
...
//	step3.foreach(value -> System.out.println(value));
 ...
 JavaPairRDD<Integer, Tuple2<Long,Integer>> step6= step5.join(cc);
